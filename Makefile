...
OBJECTS =ft_isalpha.o ft_isdigit.o ft_isprint.o ft_isascii.o ft_isalnum.o ft_strlen.o ft_memset.o ft_bzero.o ft_memcpy.o ft_memmove.o ft_memchr.o ft_memcmp.o ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_itoa.o ft_strdup.o ft_strmapi.o ft_striteri.o ft_strlcpy.o ft_strlcat.o ft_toupper.o ft_tolower.o ft_strchr.o ft_strrchr.o	ft_strncmp.o ft_strnstr.o ft_atoi.o   
# OBJS = ${SRCS: .c=.o}
HEADER = libft.h
NAME = libft
